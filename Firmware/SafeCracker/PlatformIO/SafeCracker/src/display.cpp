...
void postNumber(byte number, boolean decimal, boolean inverted)
{
  ...
  //    -. D/DP
	...
	//-- moved to arduinoGlue.h // #define a  1<<0
	//-- moved to arduinoGlue.h // #define b  1<<6
	//-- moved to arduinoGlue.h // #define c  1<<5
	//-- moved to arduinoGlue.h // #define d  1<<4
	//-- moved to arduinoGlue.h // #define e  1<<3
	//-- moved to arduinoGlue.h // #define f  1<<1
	//-- moved to arduinoGlue.h // #define g  1<<2
	//-- moved to arduinoGlue.h // #define dp 1<<7
